...
import com.example.geoezepchukac66.analytics.MovementSegment;
import com.example.geoezepchukac66.analytics.RouteAnalyzer;
import com.example.geoezepchukac66.data.LocationDatabaseHelper;
import com.example.geoezepchukac66.views.SimpleColumnChartView;
import com.example.geoezepchukac66.views.SimplePieChartView;
...
public class StatsFragment extends Fragment {
    ...
    private void loadStats() {
        ...
        List<com.example.geoezepchukac66.data.LocationPoint> points = db.getByPeriod(start,end);
