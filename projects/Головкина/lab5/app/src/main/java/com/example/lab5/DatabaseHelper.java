...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 2; // Увеличили версию для обновления
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Добавляем 30 тестовых заметок
        insertTestNotes(db, 30);
    }
    ...
    private void insertTestNotes(SQLiteDatabase db, int count) {
        ...
        for (int i = 1; i <= count; i++) {
            values.put(COLUMN_DESCRIPTION, "Заметка #" + i + " (Головкина В.Д.) - " + getRandomText());
