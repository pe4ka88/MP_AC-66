...
public class StatsFragment extends Fragment {
    ...
    private void processAndUpdateUI(List<LocationPoint> allPoints) {
        ...
        dataSet.setColor(Color.parseColor("#0F4C5C"));
        dataSet.setValueTextColor(Color.parseColor("#1E2A32"));
    ...
    private void updateUI(int totalCount, int weekCount, int monthCount,
        ...
        chart.getXAxis().setTextColor(Color.parseColor("#5E727D"));
        chart.getAxisLeft().setAxisMinimum(0);
        chart.getAxisLeft().setTextColor(Color.parseColor("#5E727D"));
        chart.getAxisRight().setEnabled(false);
        chart.getLegend().setTextColor(Color.parseColor("#5E727D"));
