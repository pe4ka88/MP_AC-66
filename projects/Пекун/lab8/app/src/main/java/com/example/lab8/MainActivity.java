...
public class MainActivity extends AppCompatActivity {
    ...
    private final String[] tabTitles = {"Маршрут", "Аналитика"};
    ...
    private void generateTestData() {
        ...
        String[] options = {
            ...
            "➖ Удалить 2 последние точки",
            "🎯 Оставить около 50 точек",
                "🔄 Очистить все данные",
        ...
        builder.setItems(options, (dialog, which) -> {
            switch (which) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    Toast.makeText(this, "Удаляю 2 последние точки...", Toast.LENGTH_SHORT).show();
                    testDataGenerator.deleteLatestPoints(2);
                    break;
                case 3:
                    Toast.makeText(this, "Сокращаю до 50 точек...", Toast.LENGTH_SHORT).show();
                    testDataGenerator.trimToTargetCount(50);
                    break;
                case 4:
